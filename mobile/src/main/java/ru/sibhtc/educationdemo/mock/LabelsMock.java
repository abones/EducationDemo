...
public class LabelsMock {
    public static Label[] labels = new Label[]
    {
        ...
        new Label(1, "00000051:FFFFFFA1:00000012:FFFFFFD3", "Кран №1", "Открывает кран №1. Давление на датчие №1 становится 0,6 МПа", true, "0,6", true,  null, "Открыт", "Закрыт"),
        new Label(2, "FFFFFFC1:00000037:00000014:FFFFFFD3", "Кран №2", "Открывает  кран №2.", true, "0", true,  null, "Открыт", "Закрыт"),
        new Label(3, "FFFFFFA0:0000006A:FFFFFFC3:00000004", "Пусковая пробка", "Пусковая пробка регулятора давления", true, "0", true, null, "Взведена", "Не взведена"),
        ...
        new Label(5, "FFFFFFC0:FFFFFF8A:FFFFFF91:00000004", "Регулировочная гайка", "Закручивается по часовой стрелке. Каждый оборот 0,2...0,4 кПа", true, "0.2", false, "кПа", null, null),
